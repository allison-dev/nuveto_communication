	...
	<table id="general-table" class="table table-hover c_table"
		...
		@foreach($data as $info)
			<tr>
                ...
                @if ($info->terminate)
                    <td class="text-left" style="color : #28a745; font-size : 20px"><i class="fas fa-check-circle"></i></td>
                @else
                    <td class="text-left" style="color : #f2282b; font-size : 20px"><i class="fas fa-times-circle"></i></i></td>
                @endif
