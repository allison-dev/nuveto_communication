<div class="container col-sm-12" style="display: flex">
    <div class="col-lg-6 col-md-6 col-sm-6">
        ...
        <div class="form-group">
            <input class="form-control {{ $errors->has('ini_date') ? 'is-invalid' : '' }}" type="date" id="ini_date" placeholder="@lang('system.inform_the_m', ['value' => trans('system.ini_date')])" value="" name="ini_date" />
    ...
    <div class="col-lg-6 col-md-6 col-sm-6">
        ...
        <div class="form-group">
            <input class="form-control {{ $errors->has('end_date') ? 'is-invalid' : '' }}" type="date" id="end_date" placeholder="@lang('system.inform_the_m', ['value' => trans('system.end_date')])" value="" name="end_date" />
