        ...
        <div class="card card-info">
            <form class="form-horizontal" action="" method="POST">
                ...
                <div class="card-footer">
                    <button id="redirect" type="button" class="btn bg-teal btn-icon float-right text-white" data-toggle="tooltip" title="@lang('system.store_invoice', ['value' => trans('system.invoices')])">
