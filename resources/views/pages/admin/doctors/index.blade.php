...
@include('pages.admin.doctors.index.breadcrumbs')
@section('content_header')
	<div class="header">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12">
				<a class="btn btn-success float-right text-white" href="{{ route('admin.doctors.create') }}" title="@lang('system.create_m', ['value' => trans('system.doctor')])">
...
<div class="card project_list">
	@if ($doctors)
		@include('pages.admin.doctors.index.table')
	@else
