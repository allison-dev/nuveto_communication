...
class FacebookCallbackController extends Controller
{
    ...
    public function facebookCallback(Request $request)
    {
        if (isset($request->entry)) {
            ...
            if (isset($events['messaging'][0]['sender']['id'])) {
                    ...
                    if (isset($facebook_session->conversationId)) {
                        ...
                        if (!$verify_session) {
                            ...
                            if (isset($create_session['tokenId']) && $create_session['tokenId']) {
                                ...
                                $params = [
                                    'callbackUrl' => isset($config->callbackUrl) && !empty($config->callbackUrl) ? $config->callbackUrl : 'https://nuveto-chat.herokuapp.com/facebook',
